...
const AboutUsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-cover bg-center bg-black">
      <div className="h-[40vh] inset-0 p-4 flex justify-center items-center bg-no-repeat  bg-center bg-cover">
      ...
      <div className=" mx-auto space-y-10">
        <div className="px-10 mb-20">
          <p className="text-gray-400 font-semibold text-xl">About Us</p>
        ...
        <div className="relative flex flex-col items-center px-10">
          ...
          <div className="w-[90%] mx-auto">
            <div className="absolute left-1/2 h-full w-[5px] bg-gray-200"></div>
